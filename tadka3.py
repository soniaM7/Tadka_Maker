...
from com.sonia.work.Spieces import Spieces
...
def spieces_masala():
    ingeredent_number = int (input("Please enter ingredients by their number: "))
    ...
    option_new = input("Do you want to add more: press y or n")
    if option_new == "y":
...
option = input("Do you want to customise Dish: press y or n ")
